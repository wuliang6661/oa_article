...
public class PopShunYanWindow extends PopupWindow {
    ...
    public PopShunYanWindow(Activity activity) {
        super(activity);

        this.activity = activity;
        View dialogView = activity.getLayoutInflater().inflate(R.layout.pop_shunyan, null);
