...
public class ComplanyZizhiFragment extends MVPBaseFragment<ComplanyZizhiContract.View, ComplanyZizhiPresenter>
    ...
    private void setUIMsg() {
        guanliNum.setText(complanBo.getCompanyInfos().getAdminNumber() + "");
        jishuNum.setText(complanBo.getCompanyInfos().getTechnicalNumber() + "");
        pugongNum.setText(complanBo.getCompanyInfos().getOrdinaryNumber() + "");
