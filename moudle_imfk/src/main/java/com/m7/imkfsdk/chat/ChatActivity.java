...
//                setChatMoreList();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImmersionBar.with(this).keyboardEnable(true).statusBarColor(R.color.maincolor).init();   //解决虚拟按键与状态栏沉浸冲突
...
//        moreList.add(chatMore4);//默认不展示评价按钮
    ...
    public void onClick(View v) {
        ...
        if (i1 == R.id.chat_tv_back) {//断开长连接
            ...
            if (!isRobot && IMChatManager.getInstance().isInvestigateOn() && convesationIsLive && hasSendPersonMsg && isZXResply && isInvestigate && hasSet && !conversationOver) {
...
//                isInvestigate = false;
    ...
    private void beginSession(String peerId) {
        // TODO: 2019/7/19 此处可用来设置专属坐席 
//        String otherParams = "";
//        JSONObject jsonObject = new JSONObject();
//        try {
//            jsonObject.put("agent", "8016");
//        } catch (JSONException e) {
//            e.printStackTrace();
//        }
//        otherParams = jsonObject.toString();
        ...
        IMChatManager.getInstance().beginSession(peerId, new OnSessionBeginListener() {
            ...
            public void onSuccess() {
                ...
                if (IMChatManager.getInstance().isShowBottomList()) {//机器人并且有bottomlist数据
